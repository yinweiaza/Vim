...
let g:template['c']['wm']="int APIENTRY WinMain(HINSTANCE hInstance,\<cr>HINSTANCE hPrevInstance,\<cr>LPSTR  lpCmdLine,\<cr>int nShowCmd)\<cr>{\<cr>".g:rs."...".g:re.";\<cr>}"
let g:template['c']['struct']="typedef  struct{\<cr>".g:rs."...".g:re."\<cr>}".g:rs."...".g:re.";"
